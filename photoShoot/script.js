$(document).ready(function(){
	...
	main.width(Math.min(865,$(document).width()));
	
	// Creating an array with four possible backgrounds and their sizes:
	
	var pics = new Array(						 
							{ url:'photoShoot/pic1.jpg', size:{x:860,y:573}},
							{ url:'photoShoot/pic2.jpg', size:{x:860,y:573}},
							{ url:'photoShoot/pic3.jpg', size:{x:860,y:573}},
							{ url:'photoShoot/pic4.jpg', size:{x:860,y:573}}
	);
	...
	function shoot(position){
		...
		// Setting the camera sound
		$('embed').remove();
		$('body').append('<embed src="../sounds/camera_click.wav" autostart="true" hidden="true" loop="false">');
