...
jQuery.fn.extend({
	mopSlider:function(setting){
		...
		if(mopSliderType=="paper"){
			btnLeft.src="product-slider/mopSlider/sliderBtnLeftW.png";
			btnLeftF.src="product-slider/mopSlider/sliderBtnLeftW_f.png";
			btnRight.src="product-slider/mopSlider/sliderBtnRightW.png";
			btnRightF.src="product-slider/mopSlider/sliderBtnRightW_f.png";
			btnCenter.src="product-slider/mopSlider/sliderBtnW.png";
			btnChange.src="product-slider/mopSlider/sliderBackRightRightW.png";
			btnChangeF.src="product-slider/mopSlider/sliderBackRightRightW_f.png";
			backImg.src="product-slider/mopSlider/paperBack.gif";
			sldcLeftImg.src="product-slider/mopSlider/sliderBackLeftLeftW.png";
			sldcRightImg.src="product-slider/mopSlider/sliderBackRightRightW.png";
			sldBackLeft.src="product-slider/mopSlider/sliderBackLeftW.png";
			sldBackCenter.src="product-slider/mopSlider/sliderBackW.png";
			sldBackRight.src="product-slider/mopSlider/sliderBackRightW.png";
		}else if(mopSliderType=="black"){
			btnLeft.src="product-slider/mopSlider/sliderBtnLeft.png";
			btnLeftF.src="product-slider/mopSlider/sliderBtnLeft_f.png";
			btnRight.src="product-slider/mopSlider/sliderBtnRight.png";
			btnRightF.src="product-slider/mopSlider/sliderBtnRight_f.png";
			btnCenter.src="product-slider/mopSlider/sliderBtn.png";
			btnChange.src="product-slider/mopSlider/sliderBackRightRight.png";
			btnChangeF.src="product-slider/mopSlider/sliderBackRightRight_f.png";
			backImg.src="product-slider/mopSlider/monoBack.gif";
			sldcLeftImg.src="product-slider/mopSlider/sliderBackLeftLeft.png";
			sldcRightImg.src="product-slider/mopSlider/sliderBackRightRight.png";
			sldBackLeft.src="product-slider/mopSlider/sliderBackLeft.png";
			sldBackCenter.src="product-slider/mopSlider/sliderBack.png";
			sldBackRight.src="product-slider/mopSlider/sliderBackRight.png";
		}
...
/*			backImg.src="product-slider/mopSlider/paperBack.gif";*/
		...
		if(mopSliderType!="tutorialzine")
		{
			...
			$(mopSliderName+" .leftTopIn").css({height:"10px",width:"10px",backgroundImage:"url(product-slider/mopSlider/sliderCorner_leftTop.png)",backgroundRepeat:"no-repeat"});
			$(mopSliderName+" .rightTop").css({height:"10px",width:"10px",position:"absolute",top:"0px",right:"0px"});
			$(mopSliderName+" .rightTopIn").css({height:"10px",width:"10px",backgroundImage:"url(product-slider/mopSlider/sliderCorner_rightTop.png)",backgroundRepeat:"no-repeat"});
			$(mopSliderName+" .leftBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",left:"0px"});
			$(mopSliderName+" .leftBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(product-slider/mopSlider/sliderCorner_leftBottom.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
			$(mopSliderName+" .rightBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",right:"0px"});
			$(mopSliderName+" .rightBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(product-slider/mopSlider/sliderCorner_rightBottom.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
	
			/*logo*/
			$(mopSliderName+" .logo").css({height:"50px",width:"80px",position:"absolute",top:"0px",left:"0px"});
			$(mopSliderName+" .logoIn").css({height:"50px",width:"80px",backgroundImage:"url(product-slider/mopSlider/logo.png)",backgroundRepeat:"no-repeat"});
		}
