...
<div id="page">
    ...
    <div id="slideshowContainer">
        <div id="slideshow">
            <img src="img/slides/slide1.gif" width="454" height="169" alt="Coming Soon: Our Awesome Web App">
            <img src="img/slides/slide2.jpg" width="454" height="169" alt="Extensive Functionality">
            <img src="img/slides/slide3.gif" width="454" height="169" alt="Complete with an iPhone App">
        </div>
	</div>
	...
	<center>
		<a href="../index.php" class="home"><img class="home" src="../engine/images/Home.png" alt="home"/></a>
	</center>
</div>
