...
<link rel="alternate" type="application/rss+xml" title="<?php bloginfo('name'); ?> RSS Feed" href="http://feeds.feedburner.com/jobbyktom/EfUI" />
...
<div id="top">
	<div id="topmenu">
		<ul>
			...
			<li><a class="rss" href="http://feeds.feedburner.com/jobbyktom/EfUI">RSS</a></li>
		</ul>
	</div>
...
<div id="header">
	...
	<div id="headerbanner">
		<p>Hey there! Thanks for dropping by <?php bloginfo( 'name' ); ?>! Take a look around and grab the <a href="http://feeds.feedburner.com/jobbyktom/EfUI">RSS feed</a> to stay updated. See you around!</p>
	</div>
	<?php endif; ?>
</div><!-- /header -->
